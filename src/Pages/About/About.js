        ...
        <div className=' container mt-5 '>
            <div className=' row  '>
                <div className=' col-lg-9 col-12 mt-5'>
                    ...
                    <p style={{ color: "#006400", marginTop: '45px' }}>My future plan is to become an entrepreneur. It's a long run and big budgeted project. However,  my recent objective is to beacome a junior front developer.  </p>
